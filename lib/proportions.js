define(["chroma-js", "virtual-dom", "numeral-intl", "filters/genericnode", "vercomp" ],
  ...
  return function (config, filterManager) {
    ...
    var manmanTable = document.createElement("table")
    manmanTable.classList.add("proportion")
    ...
    self.setData = function (data) {
      ...
      var manmanDict = count(nodes, ["nodeinfo", "manman", "location"], function (d) {
        return d ? d : "(nein)"
      })
      ...
      fillTable("ManMan", manmanTable, manmanDict.sort(function (a, b) { return b[1] - a[1] }))
    ...
    self.render = function (el) {
      ...
      self.renderSingle(el, "ManMan Standorte", manmanTable)
