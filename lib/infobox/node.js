define(["moment", "numeral", "tablesort", "tablesort.number"],
  ...
  function showManMan(d) {
    var m = dictGet(d.nodeinfo, ["manman"])
    if (!m || !m.enabled)
      return undefined
    ...
    return function (el) {
      ...
      link.href = "https://manman.ffgraz.net/location/show/" + m.location_id
      link.appendChild(document.createTextNode("Knoten " + m.node + " bei " + m.location))
  ...
  return function(config, el, router, d) {
    ...
    attributeEntry(attributes, "ManMan", showManMan(d))
